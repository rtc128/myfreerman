...
* Thu Apr 16 2026 Rodrigo Tassinari 2.5.34
- Fix in max RW threads

* Wed Apr 15 2026 Rodrigo Tassinari 2.5.33
- Changed full backup memory limit to a greater value

* Wed Apr 15 2026 Rodrigo Tassinari 2.5.32
- Fix in transaction listing from current relay log

* Mon Mar 23 2026 Rodrigo Tassinari 2.5.31
- Fix in instance creation (redo log directory)
- Better error log in instance creation

* Fri Feb 6 2026 Rodrigo Tassinari 2.5.30
- Print out Mysql SID when starting

* Tue Nov 11 2025 Rodrigo Tassinari 2.5.28
- Bug fix in version control - binlog backup

* Tue Nov 11 2025 Rodrigo Tassinari 2.5.27
- Added mysql version requirements for full backup
